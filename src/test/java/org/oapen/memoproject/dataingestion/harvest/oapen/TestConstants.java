...
final class TestConstants {
	...
	final static String xmlrecord1 = 
		  ...
		  + "						</element>"
		  + "						<element name=\"bitstream\">"
		  + "							<field name=\"name\">9780943184210.epub</field>"
		  + "							<field name=\"originalName\">9780943184210.epub</field>"
		  + "							<field name=\"description\" />"
		  + "							<field name=\"format\">application/epub+zip</field>"
		  + "							<field name=\"size\">2744896</field>"
		  + "							<field name=\"url\">https://library.oapen.org/bitstream/20.500.12657/57773/14/9780943184210.epub</field>"
		  + "							<field name=\"checksum\">e1e751753c1e7b79f393491af9d20dfa</field>"
		  + "							<field name=\"checksumAlgorithm\">MD5</field>"
		  + "							<field name=\"sid\">14</field>"
		  + "							<field name=\"dctitle\">9780943184210.epub</field>"
		  + "							<field name=\"rightsuri\">https://creativecommons.org/licenses/by-nc/4.0/</field>"
		  + "							<field name=\"rights\">CC-BY-NC</field>"
		  + "						</element>d"
		  + "					</element>"
		  + "				</element>"
		  + "				<element name=\"bundle\">"
		  ...
		  + "					</element>"
		  + "					<element name=\"grantor.doi\">"
		  + "						<field name=\"value\">10.123/456789A</field>"
		  + "					</element>"
		  + "					<element name=\"grantor.project\"/>"
		  + "					<element name=\"grantor.identifier.fundref\"/>"
		  + "				</element>"
		  + "				<element name=\"oapen.relation.isFundedBy\">"
		  ...
		  + "					</element>"
		  + "					<element name=\"grantor.doi\">"
		  + "						<field name=\"value\">10.123/456789B</field>"
		  + "					</element>"
		  + "					<element name=\"grantor.project\"/>"
		  + "					<element name=\"grantor.identifier.fundref\"/>"
		  + "				</element>"
